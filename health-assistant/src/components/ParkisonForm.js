...
export default function ParkinsonForm() {
  ...
  const fieldLabels = {
    "MDVP:Fo(Hz)": "Average Vocal Frequency (Hz)",
    "MDVP:Fhi(Hz)": "Maximum Vocal Frequency (Hz)",
    "MDVP:Flo(Hz)": "Minimum Vocal Frequency (Hz)",
    "Jitter(%)": "Voice Jitter Percentage",
  ...
  const radarFields = ["MDVP:Fo(Hz)", "MDVP:Fhi(Hz)", "Jitter(%)", "Shimmer", "NHR", "HNR"];
  ...
  const handleSubmit = (e) => {
    ...
    // Use backend logic: Check Jitter(%) > 0.3 OR NHR > 0.1
    const jitterValue = parseFloat(form["Jitter(%)"]);
    const nhrValue = parseFloat(form["NHR"]);
    
    const prediction = (jitterValue > 0.3 || nhrValue > 0.1) 
      ? "Parkinson's Disease Detected" 
      : "No Parkinson's Disease";

    const radarData = radarFields.map((key) => ({
      subject: fieldLabels[key].replace(" Frequency", "").replace(" Ratio", ""),
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ 
            ...
            Enter your voice analysis metrics for comprehensive assessment
          </p>
        </div>
        ...
        {result && (
          <div>
            {/* Prediction Card */}
            <div style={{
              background: result.prediction === "Parkinson's Disease Detected" 
              ...
              <div style={{ fontSize: "40px", marginBottom: "10px" }}>
                {result.prediction === "Parkinson's Disease Detected" ? "⚠️" : "✅"}
              </div>
              <h2 style={{
                color: result.prediction === "Parkinson's Disease Detected" ? "#991b1b" : "#065f46",
                fontSize: "26px",
                fontWeight: "700",
                margin: "0 0 8px 0"
              }}>
              ...
              <p style={{
                color: result.prediction === "Parkinson's Disease Detected" ? "#7f1d1d" : "#064e3b",
                fontSize: "14px",
                margin: 0,
                opacity: 0.9
              }}>
                {result.prediction === "Parkinson's Disease Detected" 
                  ? "We recommend consulting with a neurologist for comprehensive evaluation"
                  : "Your voice metrics are within healthy ranges"}
              </p>
            </div>
            ...
            {result.prediction === "Parkinson's Disease Detected" && (
              <div style={{
                ...
                <h3 style={{
                  ...
                  🛡️ Recommended Precaution Measures
                </h3>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <ul style={{ margin: 0, paddingLeft: "20px", fontSize: "13px", color: "#7f1d1d", lineHeight: "1.6" }}>
                      <li>Consult a neurologist immediately</li>
                      <li>Get comprehensive neurological examination</li>
                      <li>Discuss medication options (Levodopa, etc.)</li>
                  ...
                  <div style={{
                    ...
                    <ul style={{ margin: 0, paddingLeft: "20px", fontSize: "13px", color: "#1e3a8a", lineHeight: "1.6" }}>
                      <li>Start physical therapy early</li>
                      <li>Focus on balance and gait training</li>
                      <li>Include stretching exercises daily</li>
                      <li>Practice range-of-motion exercises</li>
                    </ul>
                  </div>
                  ...
                  <div style={{
                    ...
                    <ul style={{ margin: 0, paddingLeft: "20px", fontSize: "13px", color: "#78350f", lineHeight: "1.6" }}>
                      <li>Work with speech therapist</li>
                      <li>Practice vocal exercises daily</li>
                      <li>Use amplification devices if needed</li>
                      <li>Maintain clear communication techniques</li>
                    </ul>
                  </div>
                  ...
                  <div style={{
                    ...
                    <ul style={{ margin: 0, paddingLeft: "20px", fontSize: "13px", color: "#064e3b", lineHeight: "1.6" }}>
                      ...
                      <li>Stay well-hydrated throughout day</li>
                      <li>Include fiber-rich foods</li>
                      <li>Take medications with food if advised</li>
                    </ul>
                  </div>
                  ...
                  <div style={{
                    ...
                    <ul style={{ margin: 0, paddingLeft: "20px", fontSize: "13px", color: "#881337", lineHeight: "1.6" }}>
                      ...
                      <li>Join support groups for encouragement</li>
                    </ul>
                  </div>
                  ...
                  <div style={{
                    ...
                    <ul style={{ margin: 0, paddingLeft: "20px", fontSize: "13px", color: "#312e81", lineHeight: "1.6" }}>
                      <li>Remove tripping hazards at home</li>
                      <li>Install grab bars in bathroom</li>
                      <li>Ensure adequate lighting everywhere</li>
                  ...
                  <div style={{
                    ...
                    <ul style={{ margin: 0, paddingLeft: "20px", fontSize: "13px", color: "#7c2d12", lineHeight: "1.6" }}>
                      ...
                      <li>Track medication effects and side effects</li>
                      <li>Never adjust doses without doctor approval</li>
                      <li>Use pill organizers for consistency</li>
                    </ul>
                  </div>
                  ...
                  <div style={{
                    ...
                    <ul style={{ margin: 0, paddingLeft: "20px", fontSize: "13px", color: "#581c87", lineHeight: "1.6" }}>
                      ...
                      <li>Practice memory exercises regularly</li>
                      <li>Read, solve puzzles, play games</li>
                      <li>Monitor for cognitive changes</li>
                    </ul>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    ⚠️ <strong>Important:</strong> This is a screening tool only. Please consult a qualified neurologist for proper diagnosis and personalized treatment plan. Early intervention can significantly improve quality of life.
                  </p>
                </div>
              </div>
            )}
            ...
            >
                    ...
                    <Legend 
                      ...
                      formatter={(value) => (
                        <span style={{ 
                          ...
                          {value === "value" ? "Your Current Values" : "Maximum Healthy Range"}
                        </span>
                      )}
                    />
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ fontWeight: "700", color: "#8b5cf6", fontSize: "13px", marginBottom: "3px" }}>
                    Purple Area
                  </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", alignItems: "start", gap: "6px" }}>
                    ...
                    <span><strong>Inside orange:</strong> Healthy</span>
                  </div>
                  <div style={{ display: "flex", alignItems: "start", gap: "6px" }}>
                    <span style={{ fontSize: "16px" }}>⚠️</span>
                    <span><strong>Near edges:</strong> Caution</span>
                  </div>
                  <div style={{ display: "flex", alignItems: "start", gap: "6px" }}>
                    <span style={{ fontSize: "16px" }}>🔴</span>
                    <span><strong>Outside:</strong> See doctor</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Parkinson Model Comparison Table with Bar Graph */}
            <div
              style={{
                background: "rgba(255, 255, 255, 0.98)",
                borderRadius: "24px",
            ...
            >
                ...
                >
                  ...
                  <tbody>
                    <tr style={{ borderTop: "1px solid #e5e7eb" }}>
                      ...
                      <td style={{ textAlign: 'center', padding: "10px 12px" }}>0.922</td>
                      <td style={{ textAlign: 'center', padding: "10px 12px" }}>0.922</td>
                      <td style={{ textAlign: 'center', padding: "10px 12px" }}>0.923</td>
                      <td style={{ textAlign: 'center', padding: "10px 12px" }}>92.31%</td>
                    </tr>
                    ...
                    <tr style={{ borderTop: "1px solid #e5e7eb" }}>
                      ...
                      <td style={{ textAlign: 'center', padding: "10px 12px" }}>0.952</td>
                      <td style={{ textAlign: 'center', padding: "10px 12px" }}>0.947</td>
                      <td style={{ textAlign: 'center', padding: "10px 12px" }}>0.949</td>
                      <td style={{ textAlign: 'center', padding: "10px 12px" }}>94.87%</td>
                    </tr>
              ...
              <div style={{ marginTop: '28px' }}>
                ...
                <ResponsiveContainer width="100%" height={320}>
                  <BarChart
                    data={[
                      { model: 'LR', Precision: 0.922, 'F1-score': 0.922, Recall: 0.923, Accuracy: 92.31 },
                      { model: 'KNN', Precision: 0.922, 'F1-score': 0.922, Recall: 0.923, Accuracy: 92.31 },
                      { model: 'SVM', Precision: 0.952, 'F1-score': 0.947, Recall: 0.949, Accuracy: 94.87 },
                      { model: 'RFC', Precision: 0.922, 'F1-score': 0.922, Recall: 0.923, Accuracy: 92.31 }
                    ]}
                  ...
                  >
                    ...
                    />
                    <Bar dataKey="Precision" fill="#8b5cf6" radius={[8, 8, 0, 0]} />
                    <Bar dataKey="F1-score" fill="#6366f1" radius={[8, 8, 0, 0]} />
                ...
                <div style={{
                  ...
                  <strong>💡 Insight:</strong> SVM (Support Vector Machine) achieves the highest overall accuracy at 94.87% with exceptional precision (0.952) and balanced recall metrics, making it the most reliable model for Parkinson's disease detection through voice analysis.
                </div>
              </div>
            </div>
          </div>
